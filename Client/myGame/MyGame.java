...
public class MyGame extends VariableFrameRateGame
{
	...
	private GameObject tor, ghost, avatar, x, y, z;
	...
	{	Matrix4f initialTranslation, initialRotation, initialScale;
		...
		ghost = new GameObject(GameObject.root(), ghostS, ghostT);
		initialTranslation = (new Matrix4f()).translation(-1f,0f,1f);
		ghost.setLocalTranslation(initialTranslation);
		initialRotation = (new Matrix4f()).rotationY((float)java.lang.Math.toRadians(135.0f));
		ghost.setLocalRotation(initialRotation);
